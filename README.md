...
## NOTE:
Medium recently updated it's UI and the bot is currently ot running properly due to this. I am working to get this fixed. A solution will be up soon to get around the issues. Thanks for understanding. - Matt
